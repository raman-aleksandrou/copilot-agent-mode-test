...
const getApiUrl = () => {
  ...
  return `${window.location.protocol}//${window.location.hostname}:8000/api/leaderboard/`;
};
      ...
      <div className="card shadow mb-3">
        <div className="card-body">
          <div className="table-responsive">
            ...
            {data.length === 0 && <div className="text-center text-muted">No leaderboard entries found.</div>}
          </div>
        </div>
      </div>
      {/* Modal placeholder */}
